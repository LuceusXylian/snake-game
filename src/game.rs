...
impl Game {
    ...
    pub fn draw(&self, con: &Context, g: &mut G2d) {
        ...
        draw_rectangle(BORDER_COLOR, 0, 0, 1, self.height - 1, con, g);
    ...
    fn is_snake_alive(&self, dir: Option<Direction>) -> bool {
        ...
        if self.snake.is_tail_overlaping(next_x, next_y) {
            return false;
        }
    ...
    fn add_food(&mut self) {
        ...
        loop {
            ...
            if !self.snake.is_tail_overlaping(new_x, new_y) { break; }
        } 
